...
async def upload_document(
    ...
    """Upload a text/markdown/code file to the knowledge base."""
    raw = await file.read()
    try:
        ...
        raise HTTPException(
            ...
            detail="File must be UTF-8 text (markdown, txt, code, json, yaml).",
        )
    ...
    try:
        doc = await service.ingest(
            ...
            content=content,
            source=f"upload:{file.filename or 'document'}",
